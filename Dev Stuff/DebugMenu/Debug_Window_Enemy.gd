...
func update_labels():
	...
	label2.text = str(game_scene.spawned_enemies["ElectronicGuyV2"]["amount"])
...
func _on_wg_button_gui_input(_event):
	if Input.is_mouse_button_pressed(MOUSE_BUTTON_LEFT):
		game_scene.spawn_enemy(0)
	elif Input.is_mouse_button_pressed(MOUSE_BUTTON_RIGHT):
		game_scene.kill_enemy(0)
	update_labels()

func _on_tvg_button_gui_input(_event):
	if Input.is_mouse_button_pressed(MOUSE_BUTTON_LEFT):
		game_scene.spawn_enemy(1)
	elif Input.is_mouse_button_pressed(MOUSE_BUTTON_RIGHT):
		game_scene.kill_enemy(1)
	update_labels()

func _on_doll_button_gui_input(_event):
	if Input.is_mouse_button_pressed(MOUSE_BUTTON_LEFT):
		game_scene.spawn_enemy(2)
	elif Input.is_mouse_button_pressed(MOUSE_BUTTON_RIGHT):
		game_scene.kill_enemy(2)
	update_labels()

func _on_deer_button_gui_input(_event):
	if Input.is_mouse_button_pressed(MOUSE_BUTTON_LEFT):
		game_scene.spawn_enemy(3)
	elif Input.is_mouse_button_pressed(MOUSE_BUTTON_RIGHT):
		game_scene.kill_enemy(3)
	update_labels()
